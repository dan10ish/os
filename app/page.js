    ...
    <div className="desktop">
      <div className="icons">
        ...
        {siteSettings.soundtrack ?
          ...
          />
        : null}
        <a href="https://danish.bio" target="_blank" style={{ textDecoration: 'none' }}>
          <Icon
            icon={
              <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 24 24" fill="none" stroke="#0066CC" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style={{ position: 'absolute', inset: 0 }}>
